...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @EntityGraph(attributePaths = {
            "userRoles", "userRoles.role", "userRoles.role.rolePermissions", "userRoles.role.rolePermissions.permission"
    })
...
//    """)
    ...
    List<User> findAllWithFilters(@Param("typeAccount") String typeAccount,
